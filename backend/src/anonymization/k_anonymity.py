...
def k_anonymity_for_sensitive_attr(data: pd.DataFrame, quasi_idents: list) -> pd.DataFrame:
    """
    ...
    return pd.DataFrame.from_dict(group_k_scores, orient="index", columns=["k-anonymity"])
